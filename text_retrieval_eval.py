...
def run_text_retrieval(llm, captioner, captioner_strategy, prompt, dataset_path):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-prompt", "--prompt", default=None, help=f"Choose prompt. Options: {AVAILABLE_QA_PROMPT_TEMPLATES.keys()} or None")
