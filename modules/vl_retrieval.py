...
from modules.vl_transformers import CLIP, ALIGN, BLIP_COCO, BLIP_FLICKR
from modules.llms import GPT_3, GPT_3_5, BLOOMZ, OPT, GALACTICA, GPT2XL
...
AVAILABLE_LLMS = {
    ...
    'galactica-6.7b': lambda: GALACTICA(),
    'gpt2-xl': lambda: GPT2XL()
}
...
AVAILABLE_VL_PROMPT_TEMPLATES = {
    ...
    'would_say': lambda x: f"To describe {x} I would say that ",
    'could_describe': lambda x: f"I could describe {x} as ",
    'write_description': lambda x: f"Write a description of {x}."
}
